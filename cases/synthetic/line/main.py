...
domain, task_setup = line_domain.configurate_domain(poly_num=opt_params.n_polys,
...
optimizer = line_optimizer.configurate_optimizer(pop_size=opt_params.pop_size,

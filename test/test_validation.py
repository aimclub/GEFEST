...
def test_intersection():
    ...
    intersected_rectangle_poly = Polygon(
        "rectangle", points=[Point(*coords) for coords in intersected_points]
    )
...
def test_out_off_bound():
    ...
    inside_rectangle_poly = Polygon(
        "rectangle", points=[Point(*coords) for coords in inside_points]
    )
...
def test_unclosed_poly():
    ...
    closed_rectangle_poly = Polygon(
        "rectangle", points=[Point(*coords) for coords in closed_rectangle_points]
    )
